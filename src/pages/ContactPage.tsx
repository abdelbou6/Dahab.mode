      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-navy-DEFAULT text-white rounded-lg shadow-soft p-8 h-full">
              <h2 className="text-xl font-medium mb-6">Contact Information</h2>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <MapPin size={20} className="mr-4 text-gold-DEFAULT flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Phone size={20} className="mr-4 text-gold-DEFAULT flex-shrink-0 mt-1" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail size={20} className="mr-4 text-gold-DEFAULT flex-shrink-0 mt-1" />
                  <div>
              ...
              <div className="mt-12">
                ...
                <div className="flex space-x-4">
                  <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="bg-navy-light hover:bg-gold-DEFAULT text-white w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"/>
                    </svg>
                  </a>
                  <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="bg-navy-light hover:bg-gold-DEFAULT text-white w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="bg-navy-light hover:bg-gold-DEFAULT text-white w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white rounded-lg shadow-soft p-8">
              ...
              {submitted ? (
                <div className="bg-success-light bg-opacity-20 text-success-dark p-6 rounded-lg text-center">
                  ...
                  <button 
                    className="mt-4 text-teal-DEFAULT hover:text-teal-dark font-medium"
